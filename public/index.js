...
(() => {
      ...
      document.addEventListener(
        ...
        (e2) => {
          ...
          if (anchor) {
            ...
            if (href === "#" || href === "#!")
              return;
            const target2 = document.querySelector(href);
            if (target2) {
              e2.preventDefault();
          ...
          const scrollToBtn = e2.target.closest("[data-scroll-to]");
          if (!scrollToBtn)
            return;
          e2.preventDefault();
  ...
  var lenis, lenisLoaded, lenisImport, cachedNavbar;
  ...
  var cleanupFunctions, footerLocationsCleanup;
  ...
  var navbarCleanupFunctions, locationsTabsCleanup;
